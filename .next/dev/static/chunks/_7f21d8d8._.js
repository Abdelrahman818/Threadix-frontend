...
const END_POINT = {
    ...
    CATEGORIES: (id)=>`${API_BASE_URL}/categories${id ? '/' + id : ''}`,
    GET_PRODUCT: (id)=>`${API_BASE_URL}/products/item/${id}`,
    SEARCH: (route)=>`${API_BASE_URL}/${route}/search`,
    FILTER: (filter)=>`${API_BASE_URL}/filter/${filter}`,
    CONTACT: `${API_BASE_URL}/contact`,
    USERS: `${API_BASE_URL}/users`,
    GET_ROLE: `${API_BASE_URL}/auth/getRole`
};
...
function ProductsPage() {
    ...
    if ($[0] !== "fc2c2a1ba85d45d0f6f239377664d0081a2c906308028ebd9b25182e175b1829") {
        for(let $i = 0; $i < 43; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "fc2c2a1ba85d45d0f6f239377664d0081a2c906308028ebd9b25182e175b1829";
    }
    let t0;
    ...
    const [catNames, setCatNames] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t0);
    let t1;
    ...
    const [products, setProducts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t1);
    let t2;
    ...
    const [formData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t2);
    let t3;
    ...
    const [showModal, setShowModal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t3);
    let t4;
    if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = ({
            "ProductsPage[getAllProducts]": async ()=>{
                await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].PRODUCTS, {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json"
                    },
                    credentials: "include"
                }).then(_ProductsPageGetAllProductsAnonymous).then({
                    "ProductsPage[getAllProducts > (anonymous)()]": (json)=>{
                        console.log(json.data);
                        setProducts(json.data);
                        const cats = json.data.map(_ProductsPageGetAllProductsAnonymousJsonDataMap);
                        const uniqueCats = new Set(cats);
                        setCatNames(uniqueCats);
                    }
                }["ProductsPage[getAllProducts > (anonymous)()]"]).catch(_ProductsPageGetAllProductsAnonymous2);
            }
    ...
    const getAllProducts = t4;
    const handleChange = _ProductsPageHandleChange;
    const handleFileChange = _ProductsPageHandleFileChange;
    let t5;
    if ($[6] !== formData.category || $[7] !== formData.colors || $[8] !== formData.desc || $[9] !== formData.images || $[10] !== formData.price || $[11] !== formData.size || $[12] !== formData.stock || $[13] !== formData.title) {
        t5 = ({
            "ProductsPage[handleSubmit]": (e_0)=>{
                e_0.preventDefault();
                ...
                body.append("colors", formData.colors);
                body.append("images", formData.images);
                body.append("salePrice", formData.price);
                ...
                fetch(__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].PRODUCTS, {
                    ...
                    body,
                    credentials: "include"
                }).then(_ProductsPageHandleSubmitAnonymous).then(_ProductsPageHandleSubmitAnonymous2).catch(_ProductsPageHandleSubmitAnonymous3);
            }
        })["ProductsPage[handleSubmit]"];
        $[6] = formData.category;
        $[7] = formData.colors;
        $[8] = formData.desc;
        $[9] = formData.images;
        ...
        t8 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Manage all products available in Threadix store."
                        }, void 0, false, {
                            fileName: "[project]/app/admin/productMang/page.jsx",
                            lineNumber: 132,
                            columnNumber: 167
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    onClick: {
                        "ProductsPage[<button>.onClick]": ()=>setShowModal(true)
    ...
    let t11;
    if ($[20] !== catNames) {
        t11 = catNames && catNames.length > 0 && catNames.map(_ProductsPageCatNamesMap);
        $[20] = catNames;
        $[21] = t11;
    } else {
        t11 = $[21];
    ...
    let t16;
    if ($[28] !== products) {
        t16 = products && products.length > 0 && products.map(_ProductsPageProductsMap);
        $[28] = products;
        $[29] = t16;
    } else {
        t16 = $[29];
    ...
    let t18;
    if ($[32] !== catNames || $[33] !== formData.category || $[34] !== formData.price || $[35] !== formData.title || $[36] !== handleSubmit || $[37] !== showModal) {
        t18 = showModal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "Create a new product for Threadix"
                                    }, void 0, false, {
                                        fileName: "[project]/app/admin/productMang/page.jsx",
                                        lineNumber: 209,
                                        columnNumber: 303
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: {
                                    "ProductsPage[<button>.onClick]": ()=>setShowModal(false)
                                }["ProductsPage[<button>.onClick]"],
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                        ...
                                        children: [
                                            ...
                                            catNames && catNames.length > 0 && catNames.map(_ProductsPageCatNamesMap2)
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/app/admin/productMang/page.jsx",
                                        lineNumber: 211,
...
_s(ProductsPage, "xNlE3Y8JgVg6NlAmGUjMFV3jzCU=");
_c = ProductsPage;
function _ProductsPageCatNamesMap2(cat_0) {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    className: `px-2.5 py-1 text-xs font-medium rounded-lg ${product.stock ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`,
...
function _ProductsPageCatNamesMap(cat) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
        value: cat,
        children: cat
    }, void 0, false, {
...
function _ProductsPageHandleSubmitAnonymous3(error_0) {
    return console.log(error_0.message);
}
function _ProductsPageHandleSubmitAnonymous2(json_0) {
    return console.log(json_0);
}
function _ProductsPageHandleSubmitAnonymous(res_0) {
    return res_0.json();
}
function _ProductsPageHandleFileChange() {}
function _ProductsPageHandleChange() {}
function _ProductsPageGetAllProductsAnonymous2(error) {
    return console.log(error.message);
}
function _ProductsPageGetAllProductsAnonymousJsonDataMap(e) {
    return e.name;
}
function _ProductsPageGetAllProductsAnonymous(res) {
    return res.json();
}
var _c;
...
//# sourceMappingURL=_7f21d8d8._.js.map