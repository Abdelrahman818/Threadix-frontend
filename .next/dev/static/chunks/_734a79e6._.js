...
"[project]/app/admin/categoryMang/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CategoriesPage() {
    ...
    const [currMeth, setCurrMeth] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('post');
    ...
    const getAllCategories = async ()=>{
        try {
            const res = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].CATEGORIES(""), {
                credentials: "include"
            });
    ...
    const handleAction = async (action, categoryId)=>{
        switch(action){
            case 'modify':
                const cat = categories.find((c_2)=>c_2._id === categoryId);
                if (cat) {
                    setFormData({
                        name: cat.name || '',
                        image: null,
                        // Keep existing image, don't require new one for edit
                ...
                break;
            case 'delete':
                const categoryToDelete = categories.find((c_1)=>c_1._id === categoryId);
                if (confirm(`Are you sure you want to delete "${categoryToDelete?.name}"? This action cannot be undone.`)) {
                    try {
                        const res_1 = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].CATEGORIES(categoryId), {
                            method: 'DELETE',
                            credentials: 'include'
                        });
                        if (!res_1.ok) throw new Error('Failed to delete category');
                        getAllCategories();
                    } catch (err_1) {
                        console.error(err_1.message);
                        setToast({
                            show: true,
                            message: err_1.message || 'Failed to delete category',
                            type: 'error'
                        });
                    }
                }
                break;
            case 'showImg':
                const catForImage = categories.find((c_0)=>c_0._id === categoryId);
                if (catForImage) {
                    setPreviewImage({
                        url: `${__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}${catForImage.imgUrl}`,
            ...
            case 'toggleStatus':
                ...
                if (catToToggle) {
                    try {
                        ...
                        const res_0 = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].CATEGORIES(categoryId), {
                            method: 'PATCH',
                            credentials: 'include',
                            body
                        });
                        ...
                        setToast({
                            show: true,
                            message: err_0.message || 'Failed to update category status',
                            type: 'error'
                        });
                    }
                }
    ...
    const handleSubmit = async (e_0)=>{
        ...
        try {
            if (currMeth === 'post') {
                ...
                body_0.append("name", formData.name);
                body_0.append("status", formData.status);
                body_0.append("image", formData.image);
                const res_2 = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].CATEGORIES(""), {
                    method: "POST",
                    credentials: "include",
                    body: body_0
                });
                if (!res_2.ok) throw new Error("Failed to add category");
                closeModal();
                getAllCategories();
                ...
                const body_1 = new FormData();
                body_1.append("name", formData.name);
                body_1.append("status", formData.status);
                // Only append image if a new one is selected
                if (formData.image) {
                    body_1.append("image", formData.image);
                }
                const res_3 = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].CATEGORIES(editingId)}`, {
                    method: "PATCH",
                    credentials: "include",
                    body: body_1
                });
                if (!res_3.ok) throw new Error("Failed to update category");
                closeModal();
                getAllCategories();
            }
        } catch (err_2) {
            ...
            setToast({
                show: true,
                message: err_2.message || 'An error occurred',
                type: 'error'
            });
        } finally{
            setLoading(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CategoriesPage.useEffect": ()=>{
            const close = {
                "CategoriesPage.useEffect.close": ()=>setMenuPosition(null)
            }["CategoriesPage.useEffect.close"];
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                ...
                                fileName: "[project]/app/admin/categoryMang/page.jsx",
                                lineNumber: 215,
                                columnNumber: 11
                            }, this),
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-gray-500 mt-1",
                                children: "Manage all product categories in Threadix store."
                            }, void 0, false, {
                                fileName: "[project]/app/admin/categoryMang/page.jsx",
                                lineNumber: 216,
                                columnNumber: 11
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                            children: categories.map((cat_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            className: "px-6 py-4",
                                            children: cat_0.productsCount || 0
                                        }, void 0, false, {
                                            fileName: "[project]/app/admin/categoryMang/page.jsx",
                                            lineNumber: 245,
                                            columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: `px-2.5 py-1 text-xs font-medium rounded-lg ${cat_0.isActive ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`,
                                                children: cat_0.isActive
                                            }, void 0, false, {
                                                fileName: "[project]/app/admin/categoryMang/page.jsx",
                                                lineNumber: 247,
                                                columnNumber: 19
            ...
            menuPosition && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        className: "flex items-center gap-2 w-full text-left px-4 py-2 hover:bg-gray-100",
                        children: categories.find((c_3)=>c_3._id === menuPosition.categoryId)?.isActive ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                            ...
                                            children: currMeth === 'patch' ? 'Modify Category' : 'Add Category'
                                        }, void 0, false, {
                                            fileName: "[project]/app/admin/categoryMang/page.jsx",
                                            lineNumber: 313,
                                            columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: currMeth === 'patch' ? 'Update existing category' : 'Create a new category for Threadix'
                                        }, void 0, false, {
                                            fileName: "[project]/app/admin/categoryMang/page.jsx",
                                            lineNumber: 314,
                                            columnNumber: 17
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                            ...
                                            children: [
                                                "Category Image ",
                                                currMeth === 'patch' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "text-gray-400 text-xs",
                                                    children: "(Optional - leave empty to keep current image)"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/admin/categoryMang/page.jsx",
                                                    lineNumber: 335,
                                                    columnNumber: 59
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            children: loading ? currMeth === 'patch' ? 'Saving...' : 'Adding...' : currMeth === 'patch' ? 'Save Changes' : 'Add Category'
                                        }, void 0, false, {
                                            fileName: "[project]/app/admin/categoryMang/page.jsx",
                                            lineNumber: 344,
                                            columnNumber: 17
...
_s(CategoriesPage, "VYoF4kTTmBD6y85FaLBJa4lR0Ak=");
_c = CategoriesPage;
var _c;
...
//# sourceMappingURL=_734a79e6._.js.map