...
"[project]/app/admin/productMang/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProductsPage() {
    ...
    const [currColor, setCurrColor] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [currSize, setCurrSize] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [currMeth, setCurrMeth] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [editingId, setEditingId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [existingImagesCount, setExistingImagesCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const removeColor = (color)=>setColors((prev_1)=>prev_1.filter((c)=>c !== color));
    const removeSize = (size)=>setSizes((prev_2)=>prev_2.filter((s)=>s !== size));
    const getAllProducts = async ()=>{
        try {
            const res = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].PRODUCTS, {
                method: "GET",
                headers: {
    ...
    const getAllCategories = async ()=>{
        const res_0 = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].CATEGORIES(''), {
            method: 'GET',
            headers: {
                "Content-Type": "application/json"
            },
    ...
    const handleSubmit = async (e_1)=>{
        ...
        if (currMeth === 'post') {
            ...
            try {
                const res_1 = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].PRODUCTS, {
                    method: "POST",
                    body,
                    credentials: "include"
                });
                const json_1 = await res_1.json();
                if (json_1.successful) {
                    clearForm();
                    setShowModal(false);
                    getAllProducts();
                }
            ...
            const body_0 = new FormData();
            body_0.append("title", formData.title);
            body_0.append("price", formData.price);
            body_0.append("desc", formData.desc);
            body_0.append("category", formData.category);
            body_0.append("colors", JSON.stringify(colors));
            body_0.append("sizes", JSON.stringify(sizes));
            if (isFeatured) {
                body_0.append("isFeatured", "true");
            } else {
                body_0.append("isFeatured", "false");
            }
            for (let img_0 of formData.images){
                body_0.append("images", img_0);
            }
            try {
                const res_2 = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].PRODUCTS}/${editingId}`, {
                    method: "PATCH",
                    body: body_0,
                    credentials: "include"
                });
                const json_2 = await res_2.json();
                if (json_2.successful) {
                    clearForm();
                    setShowModal(false);
                    setEditingId(null);
                    setCurrMeth('');
    ...
    const updateProduct = async (id, payload)=>{
        await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].PRODUCTS}/${id}`, {
            method: 'PATCH',
            headers: {
                "Content-Type": "application/json"
            },
    ...
    const removeProduct = async (id_0)=>{
        const res_3 = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].PRODUCTS}/${id_0}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json'
            },
        ...
        if (json_3.successful) getAllProducts();
    };
    const handleAction = (action, productId)=>{
        switch(action){
            ...
            case 'edit':
                (async ()=>{
                    try {
                        const res_4 = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].PRODUCTS}/item/${productId}`, {
                            method: 'GET',
                            credentials: 'include'
                        });
                        const json_4 = await res_4.json();
                        if (json_4.successful && json_4.data) {
                            const p = json_4.data;
                            setFormData({
                                title: p.title || '',
                                price: p.price || '',
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductsPage.useEffect": ()=>{
            const close = {
                "ProductsPage.useEffect.close": ()=>setMenuPosition(null)
        ...
        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                ...
                                fileName: "[project]/app/admin/productMang/page.jsx",
                                lineNumber: 281,
                                columnNumber: 11
                            }, this),
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-gray-500 mt-1",
                                children: "Manage all products in Threadix"
                            }, void 0, false, {
                                fileName: "[project]/app/admin/productMang/page.jsx",
                                lineNumber: 282,
                                columnNumber: 11
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: `px-2 py-1 text-xs rounded ${product.stock ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            className: "px-6 py-4",
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: `px-2 py-1 text-xs rounded ${product.isFeatured ? "bg-blue-100 text-blue-700" : "bg-gray-100 text-gray-700"}`,
                                                children: product.isFeatured ? "Featured" : "Not Featured"
                                            }, void 0, false, {
                                                fileName: "[project]/app/admin/productMang/page.jsx",
                                                lineNumber: 327,
                                                columnNumber: 19
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            className: "px-6 py-4 text-gray-600",
                                            children: product.images?.length || 0
                                        }, void 0, false, {
                                            fileName: "[project]/app/admin/productMang/page.jsx",
                                            lineNumber: 331,
                                            columnNumber: 17
            ...
            showModal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "w-full max-w-2xl max-h-[90vh] bg-white rounded-2xl p-8 overflow-y-auto custom-scrollbar",
                    style: {
                        scrollbarWidth: 'thin',
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                            ...
                                            children: currMeth === 'patch' ? 'Modify Product' : 'Add Product'
                                        }, void 0, false, {
                                            fileName: "[project]/app/admin/productMang/page.jsx",
                                            lineNumber: 388,
                                            columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: currMeth === 'patch' ? 'Modify existing product' : 'Create a new product for Threadix'
                                        }, void 0, false, {
                                            fileName: "[project]/app/admin/productMang/page.jsx",
                                            lineNumber: 389,
                                            columnNumber: 17
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            ...
                                            type: "text",
                                            placeholder: "Color",
                                            onChange: (e_3)=>setCurrColor(e_3.target.value),
                                            value: currColor,
                                            className: "w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-black outline-none"
                                        }, void 0, false, {
                                            fileName: "[project]/app/admin/productMang/page.jsx",
                                        ...
                                        colors.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex gap-3.5 items-center px-2.5 py-2 bg-gray-300 rounded-sm",
                                            children: colors.map((color_0, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "cursor-pointer",
                                                    onClick: ()=>removeColor(color_0),
                                                    children: color_0
                                                }, idx, false, {
                                                    fileName: "[project]/app/admin/productMang/page.jsx",
                                                    lineNumber: 408,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            ...
                                            type: "text",
                                            placeholder: "Size",
                                            onChange: (e_4)=>setCurrSize(e_4.target.value),
                                            value: currSize,
                                            className: "w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-black outline-none"
                                        }, void 0, false, {
                                            fileName: "[project]/app/admin/productMang/page.jsx",
                                        ...
                                        sizes.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex gap-3.5 items-center px-2.5 py-2 bg-gray-300 rounded-sm",
                                            children: sizes.map((size_0, idx_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "cursor-pointer",
                                                    onClick: ()=>removeSize(size_0),
                                                    children: size_0
                                                }, idx_0, false, {
                                                    fileName: "[project]/app/admin/productMang/page.jsx",
                                                    lineNumber: 416,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    children: [
                                        ...
                                        Array.isArray(categories) && categories.length > 0 && categories.map((cat, idx_1)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                value: cat.name,
                                                children: cat.name
                                            }, idx_1, false, {
                                                fileName: "[project]/app/admin/productMang/page.jsx",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            ...
                                            id: "isFeatured",
                                            checked: isFeatured,
                                            onChange: (e_5)=>setIsFeatured(e_5.target.checked),
                                ...
                                existingImagesCount > 0 && currMeth === 'patch' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            disabled: loading,
                                            className: "px-6 py-3 bg-black text-white rounded-xl disabled:opacity-50",
                                            children: loading ? currMeth === 'patch' ? 'Saving...' : 'Adding...' : currMeth === 'patch' ? 'Save Changes' : 'Add Product'
                                        }, void 0, false, {
                                            fileName: "[project]/app/admin/productMang/page.jsx",
                                            lineNumber: 444,
                                            columnNumber: 17
...
_s(ProductsPage, "t91zG/IZxpdwVFNxAaVyC/slANc=");
_c = ProductsPage;
var _c;
...
"[project]/node_modules/lucide-react/dist/esm/icons/package-x.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const PackageX = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("package-x", __iconNode);
;
 //# sourceMappingURL=package-x.js.map
}),
"[project]/node_modules/lucide-react/dist/esm/icons/package-x.js [app-client] (ecmascript) <export default as PackageX>", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=_1802bf82._.js.map