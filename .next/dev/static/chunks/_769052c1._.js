...
"[project]/app/admin/usersMang/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UsersPage() {
    ...
    if ($[0] !== "2e35cb12a799beb39895c4f07afe327fde8595cc948f04128b0866f81b0038e0") {
        for(let $i = 0; $i < 51; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "2e35cb12a799beb39895c4f07afe327fde8595cc948f04128b0866f81b0038e0";
    }
    let t0;
    ...
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = ({
            "UsersPage[getUsers]": ()=>{
                fetch(__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].USERS, {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json"
                    },
                    credentials: "include"
                }).then(_UsersPageGetUsersAnonymous).then({
                    "UsersPage[getUsers > (anonymous)()]": (json)=>setUsers(json.data || [])
                }["UsersPage[getUsers > (anonymous)()]"]).catch(_UsersPageGetUsersAnonymous2);
            }
        })["UsersPage[getUsers]"];
        $[2] = t1;
    } else {
        ...
        t2 = ({
            "UsersPage[useEffect()]": ()=>{
                const handler = setTimeout({
                    "UsersPage[useEffect() > setTimeout()]": ()=>{
                        if (targetUser.trim()) {
                            fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].SEARCH("users")}/${targetUser}`, {
                                method: "GET",
                                headers: {
                                    "Content-Type": "application/json"
                                },
                                credentials: "include"
                            }).then(_UsersPageUseEffectSetTimeoutAnonymous).then({
                                "UsersPage[useEffect() > setTimeout() > (anonymous)()]": (json_0)=>setUsers(json_0.data || [])
                            }["UsersPage[useEffect() > setTimeout() > (anonymous)()]"]).catch(_UsersPageUseEffectSetTimeoutAnonymous2);
                        } else {
                            getUsers();
                        }
                    }
                }["UsersPage[useEffect() > setTimeout()]"], 500);
    ...
    let t4;
    let t5;
    if ($[6] !== roleFilter || $[7] !== statusFilter) {
        t4 = ({
            "UsersPage[useEffect()]": ()=>{
                ...
                fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].USERS}/filter?${params.toString()}`, {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json"
                    },
                    credentials: "include"
                }).then(_UsersPageUseEffectAnonymous).then({
                    "UsersPage[useEffect() > (anonymous)()]": (json_1)=>setUsers(json_1.data || [])
                }["UsersPage[useEffect() > (anonymous)()]"]).catch(_UsersPageUseEffectAnonymous2);
            }
        })["UsersPage[useEffect()]"];
        t5 = [
            roleFilter,
    ...
    if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
        const updateUser = {
            "UsersPage[updateUser]": (id, payload)=>{
                fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].USERS}/${id}`, {
                    method: "PATCH",
                    headers: {
                        "Content-Type": "application/json"
                    },
                ...
                }).then(_UsersPageUpdateUserAnonymous).then({
                    "UsersPage[updateUser > (anonymous)()]": ()=>getUsers()
                }["UsersPage[updateUser > (anonymous)()]"]).catch(_UsersPageUpdateUserAnonymous2);
            }
        }["UsersPage[updateUser]"];
        t6 = ({
            "UsersPage[handleAction]": (action, userId)=>{
                bb60: switch(action){
                    case "makeAdmin":
                        {
                            updateUser(userId, {
        ...
        })["UsersPage[handleAction]"];
        $[10] = t6;
    } else {
        t6 = $[10];
    }
    const handleAction = t6;
    let t7;
    let t8;
    if ($[11] === Symbol.for("react.memo_cache_sentinel")) {
        t7 = ({
            "UsersPage[useEffect()]": ()=>{
                const close = {
                    "UsersPage[useEffect() > close]": ()=>setMenuPosition(null)
                }["UsersPage[useEffect() > close]"];
        ...
        t11 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                    ...
                    fileName: "[project]/app/admin/usersMang/page.jsx",
                    lineNumber: 218,
                    columnNumber: 34
                }, this),
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    className: "text-gray-500 mt-1",
                    children: "Manage all users in the Threadix platform"
                }, void 0, false, {
                    fileName: "[project]/app/admin/usersMang/page.jsx",
                    lineNumber: 218,
                    columnNumber: 93
    ...
    if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
        t12 = ({
            "UsersPage[<input>.onChange]": (e)=>setTargetUser(e.target.value)
        })["UsersPage[<input>.onChange]"];
        $[16] = t12;
    } else {
        t12 = $[16];
    }
    ...
    if ($[19] === Symbol.for("react.memo_cache_sentinel")) {
        t14 = ({
            "UsersPage[<select>.onChange]": (e_0)=>setRoleFilter(e_0.target.value)
        })["UsersPage[<select>.onChange]"];
        $[19] = t14;
    } else {
        t14 = $[19];
    }
    ...
    if ($[25] === Symbol.for("react.memo_cache_sentinel")) {
        t19 = ({
            "UsersPage[<select>.onChange]": (e_1)=>setStatusFilter(e_1.target.value)
        })["UsersPage[<select>.onChange]"];
        $[25] = t19;
    } else {
        t19 = $[25];
    ...
    if ($[34] !== t13 || $[35] !== t24) {
        t25 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "bg-white p-5 rounded-xl border shadow-sm mb-8 flex flex-col md:flex-row gap-4",
            children: [
                t13,
                t24
            ]
    ...
    if ($[37] === Symbol.for("react.memo_cache_sentinel")) {
        t26 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
    ...
    let t27;
    if ($[38] !== menuPosition || $[39] !== users) {
        let t28;
        if ($[41] !== menuPosition) {
            t28 = ({
                "UsersPage[users.map()]": (u)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                className: "px-6 py-4",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: `px-2 py-1 text-xs rounded ${u.isActive ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`,
                                    children: u.isActive ? "Active" : "Suspended"
                                }, void 0, false, {
                                    fileName: "[project]/app/admin/usersMang/page.jsx",
                                    lineNumber: 334,
                                    columnNumber: 410
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    onClick: {
                                        "UsersPage[users.map() > <button>.onClick]": (e_2)=>{
                                            if (!menuPosition) {
                                                const rect = e_2.currentTarget.getBoundingClientRect();
                                                const spaceBelow = window.innerHeight - rect.bottom;
                                                const showUpward = spaceBelow < 200;
                                                setMenuPosition({
                                                    userId: u._id,
                                                    x: rect.right - 160,
                                                    y: showUpward ? rect.top - 200 - 8 : rect.bottom + 8
                                                });
                                            } else {
                                                setMenuPosition(null);
                                            }
                                        }
                                    }["UsersPage[users.map() > <button>.onClick]"],
    ...
    let t29;
    if ($[45] !== menuPosition) {
        t29 = menuPosition && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            style: {
                position: "fixed",
                top: menuPosition.y,
                left: menuPosition.x,
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    onClick: {
                        "UsersPage[<button>.onClick]": ()=>handleAction("makeAdmin", menuPosition.userId)
                    }["UsersPage[<button>.onClick]"],
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    onClick: {
                        "UsersPage[<button>.onClick]": ()=>handleAction("restore", menuPosition.userId)
                    }["UsersPage[<button>.onClick]"],
                    className: "flex items-center gap-2 w-full text-left px-4 py-2 hover:bg-gray-100",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$user$2d$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__UserCheck$3e$__["UserCheck"], {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    onClick: {
                        "UsersPage[<button>.onClick]": ()=>handleAction("activate", menuPosition.userId)
                    }["UsersPage[<button>.onClick]"],
                    className: "flex items-center gap-2 w-full text-left px-4 py-2 hover:bg-gray-100",
                    children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    onClick: {
                        "UsersPage[<button>.onClick]": ()=>handleAction("suspend", menuPosition.userId)
                    }["UsersPage[<button>.onClick]"],
...
_s(UsersPage, "4zcLx9HzeXRfjPA9PblOKb23efE=");
_c = UsersPage;
function _UsersPageUpdateUserAnonymous2(err_2) {
    return console.error(err_2.message);
}
function _UsersPageUpdateUserAnonymous(res_2) {
    return res_2.json();
}
function _UsersPageUseEffectAnonymous2(err_1) {
    return console.error(err_1.message);
}
function _UsersPageUseEffectAnonymous(res_1) {
    return res_1.json();
}
function _UsersPageUseEffectSetTimeoutAnonymous2(err_0) {
    return console.error(err_0.message);
}
function _UsersPageUseEffectSetTimeoutAnonymous(res_0) {
    return res_0.json();
}
function _UsersPageGetUsersAnonymous2(err) {
    return console.error(err.message);
}
function _UsersPageGetUsersAnonymous(res) {
    return res.json();
}
var _c;
...
//# sourceMappingURL=_769052c1._.js.map