...
"[project]/context/UserContext.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UserProvider({ children }) {
    ...
    const fetchUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UserProvider.useCallback[fetchUser]": async ()=>{
            try {
                setLoading(true);
                const res = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].GET_CURRENT_USER, {
                    method: 'GET',
                    headers: {
    ...
    const logout = async ()=>{
        try {
            const res_0 = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].LOGOUT, {
                method: 'POST',
                credentials: 'include'
            });
            ...
            console.error("Logout failed:", error_0.message);
        }
    };
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(UserContext.Provider, {
        ...
        fileName: "[project]/context/UserContext.js",
        lineNumber: 62,
        columnNumber: 10
    }, this);
}
_s(UserProvider, "5JadFIWSMXfLbTMIqOFs8GSksm8=", false, function() {
    return [
...
const useUser = ()=>{
    ...
    if ($[0] !== "9cc6a53411f7d458707895dbe39cfbb90f98e6d3c41b3f86379b81d37e6efb49") {
        for(let $i = 0; $i < 1; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "9cc6a53411f7d458707895dbe39cfbb90f98e6d3c41b3f86379b81d37e6efb49";
    }
...
const Header = ()=>{
    ...
    if ($[0] !== "4df3aace2a03d90159bbc6772ef9f7dcb4a413fde687df103db5f9d1316de8e5") {
        for(let $i = 0; $i < 4; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "4df3aace2a03d90159bbc6772ef9f7dcb4a413fde687df103db5f9d1316de8e5";
    }
    const { isLoggedIn, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$UserContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"])();
    let t0;
    if ($[1] !== isLoggedIn || $[2] !== logout) {
...
_s(Header, "5GuADk1AEK0OwV+t5k24B8gpjqQ=", false, function() {
    return [
...
const Categories = ()=>{
    ...
    if ($[0] !== "e1ec8323eaa3b23e82825052224f255b827ef33215b87218f3b226ede9e39b09") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e1ec8323eaa3b23e82825052224f255b827ef33215b87218f3b226ede9e39b09";
    }
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    let t0;
    ...
    if ($[5] !== categories || $[6] !== router) {
        t4 = categories?.map((cat, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                onClick: ()=>router.push(`/shop/${cat.name}`),
                className: "category-card",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "category-img",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                            src: "http://localhost:8080" + cat.imgUrl,
                            alt: "no image"
                        }, void 0, false, {
                            fileName: "[project]/components/Categories.jsx",
                            lineNumber: 54,
...
const Featured = ()=>{
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(10);
    if ($[0] !== "8aab0d26f1dbe2c8f15d1effae6f5a09799ba370bd32fa6716871cd4c259cdad") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "8aab0d26f1dbe2c8f15d1effae6f5a09799ba370bd32fa6716871cd4c259cdad";
    }
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
...
const AdminLink = ()=>{
    ...
    if ($[0] !== "cbfe0d9d3132e8fb666ce9df1d850f9baad340abed19cd6a66e23e6dc8b06a14") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "cbfe0d9d3132e8fb666ce9df1d850f9baad340abed19cd6a66e23e6dc8b06a14";
    }
    ...
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = ()=>{
            fetch(__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].GET_ROLE, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json"
                },
                credentials: "include"
            }).then(_temp).then((json)=>{
                console.log(json);
    ...
    let t2;
    if ($[3] !== isAdmin) {
        t2 = isAdmin && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
//# sourceMappingURL=_435c1b58._.js.map