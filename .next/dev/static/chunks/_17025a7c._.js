...
function UserProvider({ children }) {
    ...
    const fetchCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UserProvider.useCallback[fetchCart]": async ()=>{
            try {
                setLoading(true);
                const res_0 = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].CART(''), {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                ...
                console.error(error_0.message);
            } finally{
                setLoading(false);
            }
        }
    }["UserProvider.useCallback[fetchCart]"], []);
    const logout = async ()=>{
        try {
            const res_1 = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].LOGOUT, {
                method: 'GET',
                credentials: 'include'
            });
            ...
            console.error("Logout failed:", error_1.message);
        }
    };
...
_s(UserProvider, "exI2N1J6wm+Xuc84GVvtKMtQLCA=", false, function() {
    return [
...
const useUser = ()=>{
    ...
    if ($[0] !== "54644ccfaf7d9df381301c4e934a808dac625df99742199bc01cfd28b5af5a77") {
        for(let $i = 0; $i < 1; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "54644ccfaf7d9df381301c4e934a808dac625df99742199bc01cfd28b5af5a77";
    }
...
//# sourceMappingURL=_17025a7c._.js.map