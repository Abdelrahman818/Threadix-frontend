...
function Shop() {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(14);
    if ($[0] !== "995d2a484a2f9ccd5496e0fb81f6d21f8233eef85a60eefac64ad42fbe074719") {
        for(let $i = 0; $i < 14; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "995d2a484a2f9ccd5496e0fb81f6d21f8233eef85a60eefac64ad42fbe074719";
    }
    let t0;
    ...
    let t8;
    if ($[10] !== products) {
        t8 = products && products.length > 0 && products.map(_ShopProductsMap);
        $[10] = products;
        $[11] = t8;
    } else {
        t8 = $[11];
...
//# sourceMappingURL=_402927c2._.js.map