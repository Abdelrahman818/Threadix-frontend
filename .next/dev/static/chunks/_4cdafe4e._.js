...
function Shop() {
    ...
    if ($[0] !== "9639791630a9cea19dcd34d85cbe3590d6bed399b7b4a3810e0c2cc2f37ee423") {
        for(let $i = 0; $i < 12; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "9639791630a9cea19dcd34d85cbe3590d6bed399b7b4a3810e0c2cc2f37ee423";
    }
    let t0;
    ...
    if ($[2] !== category) {
        t1 = ({
            "Shop[useEffect()]": ()=>{
                fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_POINT"].PRODUCTS}/${category}`).then(_ShopUseEffectAnonymous).then({
    ...
    let t6;
    if ($[8] !== products) {
        t6 = products && products.length > 0 && products.map(_ShopProductsMap);
        $[8] = products;
        $[9] = t6;
    } else {
        t6 = $[9];
...
_s(Shop, "rCVjo4xRy1Oo5xo7plKQtJIDmpI=", false, function() {
    return [
...
//# sourceMappingURL=_4cdafe4e._.js.map