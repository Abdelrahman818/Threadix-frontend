module.exports = [
"[project]/app/admin/usersMang/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UsersPage() {
    ...
    const [targetUser, setTargetUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    /* =======================
      FETCH USERS
  ======================= */ const getUsers = ()=>{
        fetch(__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["END_POINT"].USERS, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
            credentials: 'include'
        }).then((res)=>res.json()).then((json)=>setUsers(json.data || [])).catch((err)=>console.error(err.message));
    };
    /* =======================
  ...
  ======================= */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const handler = setTimeout(()=>{
            if (targetUser.trim()) {
                fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["END_POINT"].SEARCH('users')}/${targetUser}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json'
                    },
  ...
  ======================= */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["END_POINT"].USERS}/filter?${params.toString()}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
  ...
  ======================= */ const updateUser = (id, payload)=>{
        fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["END_POINT"].USERS}/${id}`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json'
            },
        ...
        }).then((res)=>res.json()).then(()=>getUsers()).catch((err)=>console.error(err.message));
    };
...
//# sourceMappingURL=_a0975485._.js.map