...
;
const AuthOpts = ()=>{
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Router"])();
    ...
    const logout = ()=>{
        ...
        }).then((res)=>res.json())// .then(json => json.successful?router.reload():'')
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6bc55c97._.js.map