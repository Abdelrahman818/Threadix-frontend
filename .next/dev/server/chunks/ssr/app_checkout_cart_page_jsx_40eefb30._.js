...
function CartPage() {
    ...
    const { cartItems: ctxCartItems, loading, refreshCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$UserContext$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUser"])();
    ...
    const updateQtyOnServer = async (id, newQty)=>{
        try {
            const res = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["END_POINT"].CART(`item/${id}`), {
                method: 'PATCH',
                headers: {
    ...
    const increaseQty = async (id)=>{
        ...
        // Optimistic update
        setCartItems((items)=>items.map((i)=>i.id === id ? {
                    ...i,
                    quantity: newQty
                } : i));
    ...
    const removeItem = async (id)=>{
        try {
            ...
            if (json.successful) {
                ...
                setToast({
                    show: true,
                    message: json.msg || 'Failed to remove item',
                    type: 'error'
                });
            }
        } catch (err) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const total = cartItems?.reduce((acc, item)=>acc + item.salePrice * item.quantity, 0);
        setSubTotal(total);
    }, [
        cartItems
    ]);
            ...
            cartItems?.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: cartItems?.length > 0 && cartItems?.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "cart-item",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                        className: "rounded-md",
                                        src: __TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE_URL"] + item.image,
                                        alt: item.name,
                                        width: 120,
                                        height: 120
                                    }, void 0, false, {
...
//# sourceMappingURL=app_checkout_cart_page_jsx_40eefb30._.js.map