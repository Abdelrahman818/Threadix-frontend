...
function UsersPage() {
  ...
  ======================= */ const getUsers = ()=>{
        fetch(__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["END_POINT"].USERS, {
            ...
            credentials: 'include'
        }).then((res)=>res.json()).then((json)=>setUsers(json.data || [])).catch((err)=>console.log(err.message));
    };
    /* =======================
  ...
  ======================= */ const updateUser = (id, payload)=>{
        ...
        }).then((res)=>res.json()).then(()=>getUsers()).catch((err)=>console.log(err.message));
    };
...
//# sourceMappingURL=_893f3976._.js.map