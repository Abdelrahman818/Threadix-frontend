...
const Header = ()=>{
    ...
    const logout = ()=>{
        fetch(__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["END_POINT"].LOGOUT, {
            method: 'GET',
            credentials: 'include',
            headers: {
                'Content-Type': 'application/json'
            }
        }).then((res)=>res.json()).then((json)=>json.successful ? window.location.reload() : '').catch((error)=>console.log(error.message));
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a4b0cffc._.js.map