...
function Shop() {
    ...
    const getMatchedProducts = ()=>{
        fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["END_POINT"].SEARCH('products')}/${target}`).then((res)=>res.json()).then((json)=>{
            setProducts(json.data);
        }).catch((error)=>console.log(error.message));
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aa140251._.js.map